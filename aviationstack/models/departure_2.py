...
class Departure2(object):

    """Implementation of the 'Departure2' model.
    ...
    def __init__(self,
                 ...
                 actual_runway=None):
        """Constructor for the Departure2 class"""
    ...
    def from_dictionary(cls,
        ...
        delay = APIHelper.deserialize_union_type(UnionTypeLookUp.get('Departure2Delay'), dictionary.get('delay'), False) if dictionary.get('delay') is not None else None
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.airport,
                ...
                and APIHelper.is_valid_type(value=dictionary.gate,
                                            type_callable=lambda value: isinstance(value, str),
                                            is_value_nullable=True) \
                and UnionTypeLookUp.get('Departure2Delay').validate(dictionary.delay).is_valid \
        ...
        return APIHelper.is_valid_type(value=dictionary.get('airport'),
            ...
            and APIHelper.is_valid_type(value=dictionary.get('gate'),
                                        type_callable=lambda value: isinstance(value, str),
                                        is_value_nullable=True) \
            and UnionTypeLookUp.get('Departure2Delay').validate(dictionary.get('delay')).is_valid \
